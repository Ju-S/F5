...
this.load.image('player','/game/img/player.png')
this.load.image('ball','/game/img/ball.png')
}
...
this.physics.add.collider(this.me, this.boxes, (me, box) => {

alert("Game Over " +
"생존 시간 : "  + (time/1000).toFixed(2) +
" 점수 : " + time
